(function () {
    ...
    myclearx.controller('AdminEditController', adminEditController);
    adminEditController.$inject = ['$stateParams','$ionicScrollDelegate','errorService','$ionicSideMenuDelegate', '$ionicHistory', 'utils', '$scope', '$ionicPopup', 'httpService', 'url', '$state'];
    function adminEditController($stateParams,$ionicScrollDelegate,errorService,$ionicSideMenuDelegate, $ionicHistory, utils, $scope, $ionicPopup, httpService, url, $state) {
        ...
        $scope.getProductById = function () {
            ...
            httpService.getHttp(url.getAdmin, { 'User_id': userDetails.Tab_id })
                .then(function (data) {
        ...
        $scope.register=$stateParams.data;
        $scope.register.Mobile_no=parseInt($stateParams.data.Mobile_no);
        $scope.register.Pincode=parseInt($stateParams.data.Pincode);
        $scope.ProductData={};
