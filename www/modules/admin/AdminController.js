(function () {
    ...
    myclearx.controller('AdminController', adminController);
    adminController.$inject = ['$ionicScrollDelegate','errorService','$ionicSideMenuDelegate', '$ionicHistory', 'utils', '$scope', '$ionicPopup', 'httpService', 'url', '$state'];
    function adminController($ionicScrollDelegate,errorService,$ionicSideMenuDelegate, $ionicHistory, utils, $scope, $ionicPopup, httpService, url, $state) {
